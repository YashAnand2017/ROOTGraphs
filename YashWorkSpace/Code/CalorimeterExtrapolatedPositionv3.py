...
emb2positionDiff.Add(calextemb2positionData,calextemb2positionMonte,1,-1)
eme2positionDiff.Add(calexteme2positionData,calexteme2positionMonte,1,-1)
c3 = TCanvas()
c3.Divide(2,1,0.01,0.01,0)
c3.cd(1)
emb2positionDiff.Draw("colz")
c3.cd(2)
eme2positionDiff.Draw("colz")
c3.Draw()
