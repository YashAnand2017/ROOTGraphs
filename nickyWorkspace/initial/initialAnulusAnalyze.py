#%%writefile initialAnulusAnalyze.py
import math 
...
for jentry in xrange(entries):
        ...
        HAD300=dataTree2.trk_ClusterEnergy_HAD_300
        EM300=dataTree2.trk_ClusterEnergy_EM_300
        HAD200=dataTree2.trk_ClusterEnergy_HAD_200
        EM200=dataTree2.trk_ClusterEnergy_EM_200
...
initialAnulus = TFile("initialAnulus.root","RECREATE")
p.Write()
p2.Write()
initialAnulus.Close()