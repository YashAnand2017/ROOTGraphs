#%%writefile initialMonteAnulus.py
import math 
...
g=TH1F("g","",10,.5,10)
g.SetTitle("(Monte) EM+HAD 200-300 Anulus;Cluster Energy [GeV]")
g1=TH1F("g","",10,.5,10)
...
g3.SetTitle("(Monte) 200-300 Energy vs. p;p [geV]; Cluster Energy [GeV]")
g4=TH2D("g4","",20,.5,5,3,.5,3)
g4.SetTitle("(Monte) zoomed in;p [GeV]; Cluster Energy [GeV]")
